...
> = {
  ...
  message: {
    ...
    examples: [
      ...
      { label: "未来日表示", text: "明日の朝 8時から表示してください、今日の訪問件数を報告します" },
    ],
    tips: [
      "日時表現：「来週月曜の午後3時」「再来週火曜の午前10時半」「今週金曜の午後」などが使えます",
      "「○日から○日まで」と言うと表示期間が自動設定されます",
      "「○時から表示して」と言うと表示開始日時が設定され、その時刻まで投稿者本人にだけ「表示待ち」として見えます",
          ...
          <div>
            ...
            <div className="space-y-2">
              {content.examples.map((ex, i) => (
                ...
                >
                  <span className="text-xs font-medium text-primary bg-primary/10 rounded px-1.5 py-0.5 mr-2">
                    {ex.label}
                  </span>
