...
> = {
  ...
  message: {
    ...
    examples: [
      { label: "基本", text: "今日の午後から明日の午前中まで、インフルエンザ対策のため訪問時はマスク着用を徹底してください" },
      { label: "期間指定", text: "来週月曜から金曜まで、会議のため午前10時から12時は電話対応できません" },
      { label: "予約送信", text: "明日の朝8時に送信して、今日の訪問件数を報告します" },
    ],
    tips: [
      "「〇日から〇日まで」と言うと表示期間が自動設定されます",
      "「〇時に送信して」と言うと予約送信が設定されます",
      "重要な連絡は「重要」「緊急」と冒頭に付けると目立ちます",
    ],
  },
  record: {
    title: "訪問記録の話しかけ方",
    ...
    examples: [
      {
        label: "基本",
        text: "郡山南部チームの田中花子さん、次回訪問は来週月曜の午前10時、本人に口頭で伝えました。病状は安定しており、服薬管理ができています",
      },
      {
        label: "詳細",
        text: "身体チームの鈴木一郎さん、次回は3月20日午後2時、家族に電話で連絡済み。今日は血圧が高めで140の90、頭痛の訴えあり、主治医に報告予定",
      },
      {
        label: "伝達方法",
        text: "天理チームの佐藤美子さん、次回訪問は明後日の午後3時、カレンダーに記入しました",
      },
    ],
    tips: [
      "チーム名と利用者名を最初に言うと自動選択されます",
      "「次回は〇月〇日〇時」と言うと次回訪問日時が設定されます",
  ...
  schedule: {
    ...
    examples: [
      {
        label: "訪問変更",
        text: "郡山南部チームの山田太郎さんの訪問を明日の10時から午後2時に変更、利用者の希望のため",
      },
      {
        label: "スタッフ変更",
      ...
      {
        label: "会議変更",
        text: "来週月曜の全体会議を火曜の午後3時に変更、会場の都合のため",
      },
    ],
    tips: [
      "チーム名・利用者名・変更前後の日時を含めると精度が上がります",
      "変更理由を「〇〇のため」と言うと理由欄に転記されます",
