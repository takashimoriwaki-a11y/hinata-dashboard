...
export function AttendanceCheckModal({ type, onConfirm, onClose }: AttendanceCheckModalProps) {
  ...
  return (
    // fixed inset-0: 画面全体を覆う。overflow-y-auto でモーダル全体がスクロール可能
    <div
    ...
    >
      ...
      <div className="relative min-h-full flex items-start justify-center p-4 py-8">
        ...
        <div className="relative w-full max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
          ...
          {/* フッター */}
          <div className="px-5 py-4 border-t border-gray-200 dark:border-gray-700 flex flex-col gap-2">
            {/* 全チェック前の注意 */}
            {!allChecked && (
