    ...
    <div className={cn("flex items-start gap-1 flex-1 min-w-0 group/edit", className)}>
      ...
      {!disabled && (
        <button
          ...
          className="flex-shrink-0 p-0.5 text-muted-foreground hover:text-primary opacity-70 sm:opacity-0 sm:group-hover/edit:opacity-100 focus:opacity-100 transition-opacity"
          title="内容を編集"
        >
