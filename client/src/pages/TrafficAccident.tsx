...
import { ShieldAlert, FileSpreadsheet, FileText, ExternalLink, AlertTriangle, Car, ClipboardList, BookOpen, ChevronDown, ChevronUp } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="border border-border rounded-lg overflow-hidden">
            ...
            >
              <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 bg-red-50 dark:bg-red-900/20">
                <BookOpen className="w-4 h-4 text-red-500" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-foreground">交通事故対応マニュアル</p>
                <p className="text-xs text-muted-foreground">連絡先・手順・現場記録用紙・後日対応</p>
              </div>
              {showManual ? (
